...
export async function POST(request: NextRequest) {
  try {
    ...
    // You'll need to create an audience in Resend and get the audience ID
    // For now, we'll store the email by sending a notification to yourself
    ...
    if (audienceId) {
      ...
      await resend.emails.send({
        from: 'TendLife <onboarding@resend.dev>', // Use your verified domain
